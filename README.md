...
- **[frontload-permissions](./frontload-permissions/SKILL.md)** — Identify likely OpenCode permissions up front to avoid repeated prompts during command-heavy tasks.
